"""
Generates the chart assets referenced by site.py. Run once, before
`arklight build`. Not an ARKlight module -- ARKlight itself never
touches matplotlib; it only ever sees the finished PNGs under assets/.
"""
import matplotlib
matplotlib.use("Agg")
import matplotlib.pyplot as plt

from data import BUNDLE_SIZE, SO2025
